        ...
        <div class="flex flex-col items-center justify-center py-20">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div class="p-6 bg-white rounded-lg shadow-lg">
                    ...
                    <a href="{{ route('stations.show') }}" class="text-blue-500 hover:text-blue-700 font-medium">Explore Search Functionality &rarr;</a>
                </div>
                <div class="p-6 bg-white rounded-lg shadow-lg">
                    ...
                    <a href="{{ route('stations.create') }}" class="text-blue-500 hover:text-blue-700 font-medium">Add or Edit Charging Stations &rarr;</a>
                </div>
            </div>
        </div>
    </div>
